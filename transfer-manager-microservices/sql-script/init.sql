...
insert into test.common_settings (key, value) values ('SUCCESS_DIRECTORY', '/var/transfer-manager/Folder/successDirectory');
insert into test.common_settings (key, value) values ('ERROR_DIRECTORY', '/var/transfer-manager/Folder/errorDirectory');
insert into test.common_settings (key, value) values ('PROCESS_DIRECTORY', '/var/transfer-manager/Folder/processDirectory');
insert into test.common_settings (key, value) values ('LOADING_HERE', '/var/transfer-manager/Folder/LoadingHere');
...
insert into test.common_settings (key, value) values ('core_url', 'jdbc:postgresql://postgresql:5432/sbszh?user=postgres&password=123');
insert into test.common_settings (key, value) values ('ois_url', 'jdbc:postgresql://postgresql:5432/sbszh?user=postgres&password=123');
